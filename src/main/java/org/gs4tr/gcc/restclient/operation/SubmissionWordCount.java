...
public class SubmissionWordCount extends GCOperation {
	...
	private static final String REQUEST_URL = "submission/wordcount";
	...
	public static class SubmissionWordCountResponseData {
		...
		private List<WordCount> wordcountData;

		public SubmissionWordCountResponseData() {

		}

		public List<WordCount> getWordcountData() {
			return wordcountData;
		}

		public void setWordcountData(List<WordCount> wordcountData) {
