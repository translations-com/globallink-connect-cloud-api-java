...
public class GCExchange {
	...
	public String getConnectorsDataStore() {
		ConnectorsDataStoreGetResponse response = (ConnectorsDataStoreGetResponse) APIUtils
				.doRequest(new ConnectorsDataStoreGet(config));
	...
	public MessageResponse setConnectorsDataStore(String dataStore) {
		MessageResponse response = (MessageResponse) APIUtils
				.doRequest(new ConnectorsDataStorePost(config, new DataStoreRequest(dataStore)));
		return response;
	}
	...
	public MessageResponse cancelTask(Long taskId) {
		MessageResponse response = (MessageResponse) APIUtils
				.doRequest(new TasksCancel(config, new TaskRequest(taskId)));
		return response;
	}
	...
	public PdPhase getPdPhase(Long taskId) {
		PdPhaseResponse response = (PdPhaseResponse) APIUtils
				.doRequest(new TasksPdPhase(config, new TaskRequest(taskId)));
	...
	public MessageResponse confirmTaskCancellation(Long taskId) {
		MessageResponse response = (MessageResponse) APIUtils
				.doRequest(new TasksConfirmCancellation(config, new TaskRequest(taskId)));
		return response;
	}
